...
Original file is located at
    https://colab.research.google.com/drive/1X3U8wfQzuPejY8LdKu-WAs-X91pPcLum
"""
...
if file_bytes is not None:
    ...
    new_title = '<p style="font-family:sans-serif; color:Green; font-size: 32px;">Recommended Items for above 
